...
export async function GET(req: Request) {
  ...
  try {
    ...
    // Vinicius - oficina (senha definida + hasheada) - shopId corrigido para shop-vinicius-001 (onde os dados foram importados)
    await prisma.user.upsert({ where: { email: 'vinicius.motospecas@hotmail.com' }, update: { hashedPassword: '$2b$10$0ug1osokxwsZa.8ybBOtnevUNC7V6FOLagxk5ne.UuAAFQV1RSjGa', shopId: 'shop-vinicius-001' }, create: { id: 'cmovly7ws0002rw087zjtaq0t', name: 'Vinicius Brito', email: 'vinicius.motospecas@hotmail.com', hashedPassword: '$2b$10$0ug1osokxwsZa.8ybBOtnevUNC7V6FOLagxk5ne.UuAAFQV1RSjGa', role: 'admin', shopId: 'shop-vinicius-001' } });
